...
<head>
	...
	*/
	...
	function getLocations(){
		...
		var cityGeocode = [];
		$.get("RequestHandler3.php", { param : 'Pop_Crim_Loc' }, function(data){
			...
			for (var key in lat_lngs) {
				cityGeocode.push({"location" : new google.maps.LatLng(lat_lngs[key].lat, lat_lngs[key].lng), "weight" : lat_lngs[key].weight});
			}
	...
	function getStates(){
		...
		$.get("RequestHandler3.php", { param : 'Pop_Crim_State' }, function(data){
	...
	$('.states').on('change', function(){
		if($(this).val() != 0){
			...
			if(crime_selected.length > 0 ){
				...
				$.get("RequestHandler3.php", parameter , function(data){
