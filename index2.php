...
<head>
	...
	*/
	...
	function getLocations(){
		...
		var cityGeocode = [];
		$.get("RequestHandler2.php", { param : 'Pop_Crim_Loc' }, function(data){
	...
	function getStates(){
		...
		$.get("RequestHandler2.php", { param : 'Pop_Crim_State' }, function(data){
	...
	$('.states').on('change', function(){
		if($(this).val() != 0){
			...
			if(crime_selected.length > 0 ){
				...
				$.get("RequestHandler2.php", parameter , function(data){
